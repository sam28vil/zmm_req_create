		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Criar Requisição em Massa",
									"targetURL": "#mrscombrzmmreqcreate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrscombrzmmreqcreate-display": {
								"semanticObject": "mrscombrzmmreqcreate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrs.com.br.zmmreqcreate",
									"url": sap.ui.require.toUrl("mrs/com/br/zmmreqcreate")
								}
							}
						}
					}
